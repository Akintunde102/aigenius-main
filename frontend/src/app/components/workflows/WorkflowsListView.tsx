  ...
  return (
    <div className="flex min-h-screen flex-col" style={workflowShellBgStyle()}>
      <div className="flex min-h-0 flex-1 flex-col bg-white/80 backdrop-blur-[2px] dark:bg-slate-950/80">
        {/* List header: theme-aware chrome (clean light in light mode, dark in dark mode). */}
            ...
            <div className="mx-auto w-full max-w-6xl flex-1 px-4 py-6 sm:px-6 sm:py-8">
              {loading ? (
                ...
                <div className="flex flex-col items-center gap-4 py-20 text-center">
                  <p className="max-w-md text-sm leading-relaxed text-slate-700 dark:text-slate-300">{loadError}</p>
                  <Button
                    type="button"
                    variant="outline"
                    size="sm"
                ...
                <div className="flex flex-col items-center gap-4 py-16 text-center">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-slate-200/90 bg-white/90 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.9)] dark:border-slate-800 dark:bg-slate-900/90 dark:shadow-none">
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  {filtered.map((w) => {
                    ...
                    return (
                      <div key={w.id} className="relative rounded-xl border border-[rgba(58,71,87,0.15)] bg-white shadow-[0_8px_28px_-18px_rgba(31,42,55,0.35)] transition hover:shadow-[0_12px_32px_-16px_rgba(31,42,55,0.4)] dark:border-slate-800/90 dark:bg-[#18191c] dark:shadow-[0_8px_28px_-18px_rgba(0,0,0,0.6)] dark:hover:border-slate-700">
                        <Link href={`/workflow/${w.id}`} className="group block text-left">
                          <div className="flex items-center gap-2 rounded-t-xl border-b border-[rgba(58,71,87,0.08)] bg-[rgba(255,255,255,0.92)] px-3 py-2.5 pr-11 dark:border-slate-800/80 dark:bg-[#1e2024]">
                            <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-cyan-50 text-cyan-600 dark:bg-cyan-950/60 dark:text-cyan-400">
                        ...
                        <div className="absolute right-2 top-2 z-10">
                          ...
                          {menuWorkflowId === w.id ? (
                            <div
                              className="absolute right-0 mt-1 w-36 overflow-hidden rounded-lg border border-slate-200 bg-white py-1 text-[11px] shadow-lg dark:border-slate-700 dark:bg-slate-800"
                            ...
                            >
                              ...
                              <button
                                ...
                                className="w-full border-t border-slate-100 px-2.5 py-1.5 text-left text-red-600 transition hover:bg-red-50 disabled:opacity-50 dark:border-slate-700 dark:text-red-400 dark:hover:bg-red-950/40"
                                onClick={(e) => {
                                  e.stopPropagation();
