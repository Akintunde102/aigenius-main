...
describe('Async Calls', () => {
  ...
  describe('_insert function', () => {
    ...
    it.skip('should throw error on insert of bad item into project', async () => {
      await expect(
        _insertOne({
          ...args,
          body: bad_data,
    ...
    it.skip('should throw error on insert of bad item into project, error type must be CallError', async () => {
      try {
        const result = await _insertOne({
          ...args,
          body: bad_data,
