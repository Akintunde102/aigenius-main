...
export const TOOL_DISPLAY_NAMES: Record<string, string> = {
    ...
    read_file: 'Read local file (desktop)',
    read_local_file: 'Read local file (desktop)',
    ...
    local_list_symbols: 'Search symbols (desktop)',
    local_find_references: 'Find references (desktop)',
    local_find_callers: 'Find callers (desktop)',
    local_trace_call_chain: 'Trace call chain (desktop)',
    local_symbol_blast_radius: 'Symbol blast radius (desktop)',
    local_type_flow_trace: 'Type flow trace (desktop)',
    local_grep: 'Grep codebase (desktop)',
    local_go_to_definition: 'Go to definition (desktop)',
    local_import_blast_radius: 'Import blast radius (desktop)',
    local_git_status: 'Git status (desktop)',
    local_git_diff: 'Git diff (desktop)',
