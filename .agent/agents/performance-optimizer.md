...
## Electron desktop (AIGenius)

For **`desktop/`** (Electron main, preload, IPC) or renderer behavior specific to the embedded shell, load **`electron-desktop-performance`** and prefer **`@desktop-electron-specialist`**. Principles align with [Building High-Performance Electron Apps — Johnny Le](https://www.johnnyle.io/read/electron-performance) and the Electron project’s [performance guidance](https://www.electronjs.org/docs/latest/tutorial/performance).
