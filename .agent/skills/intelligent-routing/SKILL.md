...
| **Electron desktop** | "electron", "BrowserWindow", "preload", "ipcMain", "ipcRenderer", "main process", "desktop shell" | `desktop-electron-specialist`               | ✅ YES       |
...
| **Electron**    | electron, ipc, preload, BrowserWindow, BrowserView, shell | `desktop-electron-specialist` |
