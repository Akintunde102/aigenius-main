...
from voice_sidecar_lib.tts_pocket import generate_speech, warm_tts_at_sidecar_startup
...
async def run_stdio_json_command_loop() -> None:
    ...
    with log_timed_step("Initial model load"):
        ...
        # Background thread: first TTS should not stall ~15s. HF hangs are guarded in load_tts_model.
        warm_tts_at_sidecar_startup()
